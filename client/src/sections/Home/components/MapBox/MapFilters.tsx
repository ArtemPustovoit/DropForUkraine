...
const MapFilters: React.FC<FiltersProps & FormComponentProps<Filters>> = ({
  form,
  countries,
  types,
  capacity,
    ...
    <Form layout="vertical">
      ...
      <Form.Item label="Capacity">
        {form.getFieldDecorator("capacity", {
          initialValue: [capacity.min, capacity.max],
        })(
          <Slider
            range
            min={capacity.min}
...
const MapFiltersWrapper = Form.create<
  FiltersProps & FormComponentProps<Filters>
>({
  name: "map_filters",
  onValuesChange: (props) =>
    props.onChange(props.form.getFieldsValue() as Filters),
})(MapFilters);
